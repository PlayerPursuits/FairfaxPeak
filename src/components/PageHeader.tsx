...
export function PageHeader({ eyebrow, title, children }: { eyebrow?: string; title: string; children?: ReactNode }) {
  return (
    <div className="border-b border-stone-200 bg-gradient-to-b from-pine-50 to-stone-25">
      <div className="container-page py-10 sm:py-14">
        {eyebrow && <p className="text-sm font-semibold tracking-wide text-pine-600 uppercase">{eyebrow}</p>}
