...
// creates what's missing and never overwrites existing rows — so it runs on
// every Vercel deploy (see the "build" script).
...
// Run directly: `npm run db:seed:base`
if (process.argv[1]?.includes("seed-base")) {
